...
public abstract class Record {
    ...
    public final Object getFieldValue(String key) {
        ...
        try {
            ...
            try {
                ...
                this.fetch();
                value = this.fields.get(key).getValue();
            } catch (SQLException | RecordNotFoundException | UninitializedFieldException ex) {
    ...
    /**
     * Called before saving the record; override it if it is necessary in your subclass.
     */
    protected void savePrep() {
    }

    /**
     * Called after saving the record; override it if it is necessary in your subclass.
     */
    ...
    public final void save() throws SQLException {
        ...
        if (!this.getField("pkey").getWasInitialized()) { // New record
            ...
            if (rs.next()) {
                ...
                throw new RecordSaveException("Couldn't verify that record was saved.");
            }
