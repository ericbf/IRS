...
public abstract class Record {
    ...
    /**
     * Fetches the record in the database associated with getPkey(), using the fetchMode specified. fetchMode is an enum
     * specifying what type of column should be retrieved.
     */
