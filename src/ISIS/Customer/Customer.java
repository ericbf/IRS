 ...
 * Invariants:
 *
 * The Customer record references exactly one set of associated dates.
 *
 * @dates != null
 *
 * The Customer record references a customer status field.
 * @active == true || active == false
 *
 * The customer record has a primary key field that is always set.
 * @pkey > 0
 *
 * The customer record name fields are always set.
