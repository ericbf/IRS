...
/**
 * Attributes of an item as it relates to a transaction -- e.g. amount being bought, a discount, or a note.
 */
public class TransactionLineItem {
    ...
    /**
     * Gets an adjustment associated with the transaction and item, e.g. a discount.
     */
