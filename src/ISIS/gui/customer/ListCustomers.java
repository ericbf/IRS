    ...
    protected void fillTable() {
        ...
        try {
            if (searchFieldText.length() >= 1) {
                ...
                String sqlQuery = "SELECT c.*, 'phone' AS phone FROM (SELECT docid FROM customer_search WHERE customer_search MATCH ?) " + "LEFT JOIN customer AS c ON docid=c.pkey";
