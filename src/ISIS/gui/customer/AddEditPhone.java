...
public class AddEditPhone extends AddEditView {
    ...
    private Phone phone;
    private HintField phoneNo;
    final JComboBox<Phone.PhoneType> type = new JComboBox<>(Phone.PhoneType.values());
    ...
    public Record getCurrentRecord() {
        ...
        if (this.phone == null) {
            this.phone = new Phone(this.phoneNo.getText(), false, (Phone.PhoneType) this.type.getSelectedItem());
    ...
    private void populateElements() {
        ...
        c.gridwidth = 2;
        c.fill = GridBagConstraints.BOTH;
        this.add(this.phoneNo = new HintField("Phone #"), c);
    }
