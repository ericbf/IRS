 ...
 */
public class ListTransactionLineItem extends SimpleListView<TransactionLineItem> {
    private static final long	serialVersionUID	= 1L;
    Transaction transaction;

    public ListTransactionLineItem(SplitPane splitPane, View pusher, Transaction transaction) {
        super(splitPane, pusher, false, "SELECT ti.* FROM transaction_item AS ti "
