...
public class AddEditAddress extends AddEditView {
    ...
    public Record getCurrentRecord() throws BadInputException {
        ...
        if (this.address == null) {
            this.address = new Address(this.active.isSelected(), false, this.country.getText(), this.title.getText(), this.zip.getText(),
                                       this.state.getText(), this.city.getText(), this.county.getText(), this.st_address.getText());
            this.customer.addAddress(this.address);
            //TODO: fixme
            this.disableFields(this.country, this.country, this.title, this.zip, this.state, this.city, this.county, this.st_address);
        } else {
