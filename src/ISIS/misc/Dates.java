...
/**
 * Generic class for various date information that is not typically set or modified explicitly by the user. The fields
 * are modification date/user and creation date/user. All fields are final.
 *
 * Invariants:
 *
